...
- list songs; shows them a list of songs in using the #list_songs method in the song class, which returns an array, then pass the array to the #diaplay_songs in CLI Environment class, which displays the songs as following
